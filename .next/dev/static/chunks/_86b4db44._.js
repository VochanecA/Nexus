...
function SignupForm() {
    ...
    const handleSubmit = async (e)=>{
        ...
        const { error } = await supabase.auth.signUp({
            ...
            password,
            options: {
                emailRedirectTo: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_DEV_SUPABASE_REDIRECT_URL || `${window.location.origin}/home`,
                data: {
                    username,
...
_s(SignupForm, "gjwjtukng0xpEowj8Tmo2b8QyCY=", false, function() {
    return [
...
//# sourceMappingURL=_86b4db44._.js.map