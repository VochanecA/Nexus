...
function ImagePreview({ imageUrl, alt, onClose }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ImagePreview.useEffect": ()=>{
            ...
            const handleEscape = {
                "ImagePreview.useEffect.handleEscape": (e)=>{
                    if (e.key === 'Escape') {
                        handleClose();
                    }
                }
            }["ImagePreview.useEffect.handleEscape"];
...
_s1(ImagePreview, "+e2VRK3nwbwNXVQz7J47yjmF2/I=");
_c1 = ImagePreview;
function PostCard({ post, showFollowButton = false, currentUserId, isCurrentUserFollowing = false, onFollowChange, compact = false, onRepost }) {
    ...
    const [imageLoadError, setImageLoadError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    // Debug logging
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PostCard.useEffect": ()=>{
...
_s2(PostCard, "NTaWtknfpqqEdmORy5weTnPmhXc=", false, function() {
    return [
...
function PublicFeed() {
        ...
        "PublicFeed.useCallback[formatPostsWithCounts]": async (postsData)=>{
            ...
            try {
                ...
                const likesMap = (likesResult.data || []).reduce({
                    "PublicFeed.useCallback[formatPostsWithCounts].likesMap": (acc, like)=>{
                        acc[like.post_id] = (acc[like.post_id] || 0) + 1;
                        return acc;
                    }
                }["PublicFeed.useCallback[formatPostsWithCounts].likesMap"], {});
                const commentsMap = (commentsResult.data || []).reduce({
                    "PublicFeed.useCallback[formatPostsWithCounts].commentsMap": (acc, comment)=>{
                        acc[comment.post_id] = (acc[comment.post_id] || 0) + 1;
                        return acc;
                    }
                }["PublicFeed.useCallback[formatPostsWithCounts].commentsMap"], {});
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PublicFeed.useEffect": ()=>{
            ...
            }["PublicFeed.useEffect.interval"], 5 * 60 * 1000);
            return ({
...
_s(PublicFeed, "NaW9n85tKl4uIbOmyUZE+K8sk+g=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
