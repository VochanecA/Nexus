...
"[project]/components/post/create-post.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
_s(CreatePost, "yHn6JjySPi4SCxbbB/qLK8/8c3I=", false, function() {
    return [
...
;
;
function Feed({ userId, followingUserIds, isAuthenticated }) {
    _s();
    ...
    const fetchPosts = async (pageNum, reset = false)=>{
        ...
        `).order("created_at", {
            ...
            // Ako korisnik prati neke korisnike, prikaži njihove postove prvo
            if (isAuthenticated && followingUserIds && followingUserIds.length > 0) {
                // Prvo dohvati postove od korisnika koje prati
                const followingPosts = await query.in("user_id", followingUserIds).then(({ data, error })=>{
                    if (error) throw error;
                    return data || [];
                });
                // Ako nema dovoljno postova od pratilaca, dopuni sa ostalim postovima
                if (followingPosts.length < postsPerPage) {
                    const remaining = postsPerPage - followingPosts.length;
                    const otherPosts = await supabase.from("posts").select(`
              *,
              profiles!posts_user_id_fkey (
                username,
                display_name,
            ...
            `).not("user_id", "in", `(${followingUserIds.join(",")})`).order("created_at", {
                        ascending: false
                    }).limit(remaining).then(({ data, error })=>{
                        if (error) throw error;
                        return data || [];
                    });
                    const allPosts = [
                    ...
                    setHasMore(followingPosts.length === postsPerPage);
                }
            } else {
                // Ako nije logovan ili ne prati nikoga, prikaži sve postove
                ...
                setHasMore((data?.length || 0) === postsPerPage);
            }
        } catch (err) {
    ...
    // Formatiranje postova za PostCard komponentu
    const formattedPosts = posts.map((post)=>({
            ...
            user_has_liked: isAuthenticated ? post.likes?.some((like)=>like.user_id === userId) : false
        }));
        ...
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    ...
                    children: isAuthenticated ? "No posts yet. Follow some users or create your first post!" : "No posts yet. Sign in to create the first post!"
                }, void 0, false, {
                    fileName: "[project]/components/feed/feed.tsx",
                    lineNumber: 189,
                    columnNumber: 9
...
_s(Feed, "FXUq7SeBtk4qspCsllgAAgsrk+g=");
_c = Feed;
var _c;
...
//# sourceMappingURL=_84db50da._.js.map