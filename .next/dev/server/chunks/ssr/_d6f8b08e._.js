...
;
;
function PostCard({ post, showFollowButton = false, currentUserId, isCurrentUserFollowing = false, onFollowChange, compact = false }) {
    ...
    const handleShare = async (e)=>{
        ...
        // Dodajte toast notifikaciju ovdje
        }
    };
    ...
    // Helper za dropdown stop propagation
...
"[project]/lib/feed-engine/algorithms/chronological.ts [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
class FeedGenerator {
    ...
    async generateFeed(request) {
        ...
        const postData = posts.map(this.convertToPostData);
    ...
    async getBasePosts(request) {
      ...
      `).order('created_at', {
            ascending: false
        }).limit(100); // Base limit for scoring
        // For logged-in users, we could apply basic filtering
        if (request.userId) {
        // Could filter by follows, etc.
        }
    ...
    convertToPostData(postWithProfile) {
        return {
            ...
            user_has_liked: false // This would need to be calculated based on user likes
        };
    }
    async scorePosts(posts, algorithm, request) {
        ...
        const scoredPosts = await Promise.all(posts.map(async (post)=>{
            ...
            if (request.userId) {
                await this.logSignals(request.userId, post.id, algorithm.id, result.signals, result.score);
            }
            return {
                post,
                score: result.score,
    ...
    async logSignals(userId, postId, algorithmId, signals, totalScore) {
        try {
            ...
            if (error) {
                console.error('Error logging signals:', error);
            }
        } catch (error) {
            console.error('Error in logSignals:', error);
        }
    }
    generateSummary(signals, algorithmName) {
        const topSignal = signals[0];
        if (!topSignal) return 'No significant signals detected.';
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$progress$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/ui/progress.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/client/app-dir/link.js [app-ssr] (ecmascript)");
// Import feed engine components using barrel exports
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$feed$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/components/feed/index.ts [app-ssr] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$feed$2f$feed$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/feed/feed.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$feed$2f$AlgorithmFeed$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/feed/AlgorithmFeed.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$feed$2f$AlgorithmSelector$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/feed/AlgorithmSelector.tsx [app-ssr] (ecmascript)");
...
function HomePage() {
    ...
    async function loadActiveAlgorithm(userId) {
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                ...
                                                                children: followingUserIds.length - 1
                                                            }, void 0, false, {
                                                                fileName: "[project]/app/home/page.tsx",
                                                                lineNumber: 533,
                                                                columnNumber: 21
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                feedTab === 'algorithm' ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$feed$2f$AlgorithmFeed$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AlgorithmFeed"], {
                                    ...
                                    onExplanationToggle: setActiveExplanation,
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: user && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$feed$2f$AlgorithmSelector$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AlgorithmSelector"], {
                                ...
                                onAlgorithmChange: (algorithm)=>{
                                    ...
                                    // Refresh feed when algorithm changes
                                    window.location.reload();
                                }
                            }, void 0, false, {
                                fileName: "[project]/app/home/page.tsx",
...
//# sourceMappingURL=_d6f8b08e._.js.map